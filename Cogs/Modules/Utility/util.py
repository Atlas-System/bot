...
class Util(commands.Cog):
    ...
    async def premium(self, ctx: commands.Context):
        embed = Embed(
            title="Pricing",
            description="Atlas's basic features are free, forever. But you can buy both Premium and Custom Branding. Custom Branding comes with Premium.",
            color=Color.dark_embed()
        )

        item = discord.ui.Button(label="Premium", style=ButtonStyle.url, url="https://buy.stripe.com/fZe8zU21a50CgTu6oo")
        item2 = discord.ui.Button(label="Custom Branding", style=ButtonStyle.url, url="https://buy.stripe.com/4gw3cX1a5f0CgTu6oo")
    ...
    @app_commands.command(name="translate", description="Translate a message using Google Translate")
    @app_commands.describe(language="Language to translate to", message="Message to translate")
    ...
    async def translate(
        ...
        try:
            translated = MyMemoryTranslator(source='en-GB', target=language).translate(message)
